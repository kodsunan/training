...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"]==="POST") {
        ...
        if ( !empty($_POST["input_ctname"])  ) {
            ...
            $my_ctname =$_POST["input_ctname"];
            //$my_info =$_POST["input_myinfo"];
            //echo "Hello, ".$my_text." ! ";

            $sql_string = " INSERT INTO in_cars_type(ct_name) VALUE ('{$my_ctname}') ";
            //echo $sql_string;
...
<h1><div align="center">เพิ่มประเภทรถยนต์</h1>

<form class="" action="?" method="post">

    ประเภทรถยนต์ : <input type="text" name="input_ctname" value="" placeholder="type's name">
